...
import { PreDisbursalDocumentStyles } from './PreDisbursalDocumentStyles';
...
class PreDisbursalDocument extends Component {
    ...
    componentDidMount() {
        ...
        this.props.getDisbursementDOCUMENT({
            ...
            callback: (response) => {
                ...
                if (response && response.data && response.data.custDoc && response.data.custDoc.filePath) {

                    this.setState({
                        custDocUpload: true,
                        custDoc: {
                            filename: response.data.custDoc.fileName,
                            idToEdit: response.data.custDoc.id || "",
                            filePath: response.data.custDoc.filePath.replace('/var/www/html', uatURL.URL) || "",
                            pdf: response.data.custDoc.fileName.split('.').pop() == "pdf" ? true : false
                        },
                        preDisbursalDocument: {
                            customerDoc: false,
                        }
                ...
                if (response && response.data && response.data.delarQuotation && response.data.delarQuotation.filePath) {
                    this.setState({
                        delarQuotation: true,
                        delarQuotationDoc: {
                            filename: response.data.delarQuotation.fileName,
                            idToEdit: response.data.delarQuotation.id || "",
                            filePath: response.data.delarQuotation.filePath.replace('/var/www/html', uatURL.URL) || "",
                            pdf: response.data.delarQuotation.fileName.split('.').pop() == "pdf" ? true : false
                        },
                        preDisbursalDocument: {
                            delarQuotation: false,
                        }
                ...
                if (response && response.data && response.data.eSign && response.data.eSign.filePath) {
                    this.setState({
                        eSignUpload: true,
                        eSign: {
                            filename: response.data.eSign.fileName,
                            idToEdit: response.data.eSign.id || "",
                            filePath: response.data.eSign.filePath.replace('/var/www/html', uatURL.URL) || "",
                            pdf: response.data.eSign.fileName.split('.').pop() == "pdf" ? true : false
                        },
                        preDisbursalDocument: {
                            eSign: false,
                        }
                ...
                if (response && response.data && response.data.nach && response.data.nach.filePath) {
                    this.setState({
                        nachUpload: true,
                        nach: {
                            filename: response.data.nach.fileName,
                            idToEdit: response.data.nach.id || "",
                            filePath: response.data.nach.filePath.replace('/var/www/html', uatURL.URL) || "",
                            pdf: response.data.nach.fileName.split('.').pop() == "pdf" ? true : false
                        },
                        preDisbursalDocument: {
                            nach: false,
                        }
    ...
    CustomerDoc() {
        ...
        if (this.state.preDisbursalDocument.customerDoc) {
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
                        this.handleCollapseExpand("customerDoc", false);
                    }}>
                        <Text style={pddLabel}>{"Customer Photo*"}</Text>
                ...
                <View style={expandedContainer}>
                    ...
                    <View style={expandedViewStyle}>
                        ...
                        <TouchableOpacity onPress={() => {
                            this.handleCollapseExpand("customerDoc", true);
                        }}>
                    ...
                    <View style={{ marginBottom: 20 }}>
                        ...
                        {this.state.custDocUpload === false && (
                                            ...
                                            if (!this.state.isViewOnly) {
                                                    ...
                                                    if (bytesToMegaBytes(image.size) > 5) {
                                                        ImageResizer.createResizedImage(image.path, 1200, 1200, 'JPEG', 100, 0)
                                                            .then((response) => {
                                                                ...
                                                                zipFileDisbursementTakePhoto2(response, this.state.custDoc, this.props.uploadDisbusementDOCUMENT, callback)
                                                            }).catch(err => {
                                                            });
                                                    } else {
                                                        this.setState((state, props) => ({
                                                        ...
                                                        zipFileDisbursementTakePhoto(image, this.state.custDoc, this.props.uploadDisbusementDOCUMENT, callback)
                                                    }
                                                })
                                                const callback = (response) => {
                                                    this.setState({
                                                        custDocUpload: true,
                                                        custDoc: {
                                                            filename: response?.custDoc?.fileName,
                                                            filePath: response?.custDoc?.filePath?.replace('/var/www/html', uatURL.URL),
                                                            pdf: response?.custDoc?.fileName?.split('.').pop() == 'pdf' ? true : false
                                                        }
                                    ...
                                    <Button
                                        ...
                                        onPress={async () => {
                                            if (!this.state.isViewOnly) {
                                                ...
                                                zipFileDisbursementUpload(fileDetails, this.state.custDoc, this.props.uploadDisbusementDOCUMENT, callback);
                                            }
                                        }}
                                    />
                                </View>
                        ...
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', marginBottom: 10 }}>
                                ...
                                {!this.state.custDoc.pdf ?
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => {
                                            Linking.openURL(this.state.custDoc.filePath)
                                        }
                                        }>
                                            <Text style={[textFileName, { flex: 1 }]}>
                                                {this.state.custDoc.filename}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
                                }
                                        ...
                                        if (!this.state.isViewOnly) {
                                            this.props.deleteDisbursementDOCUMENT({
                                                data: {
                                                    ...
                                                    docType: "custDoc",
                                                    disbursementType: this.state.disbursementType,
                                                    docName: this.state.custDoc.filename
                                                },
                                                callback: (response) => {
                                                    this.setState((state, props) => ({
                                                        custDoc: {
                            ...
                            {!this.state.custDoc.pdf ?
                                <Text style={{ marginBottom: 10, alignSelf: 'center', }}>
                                    ...
                                    <Text style={textFileName}> {this.state.custDoc.filename}</Text>
                                </Text>
                                : null}
            ...
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
                        ...
                        <Text style={pddLabel}>{"References"}</Text>
                        <Image source={BLUE_PLUS_ICON} style={plusImageStyle} />
                    </TouchableOpacity>
                </View>
            );
            ...
            return (
                <View style={expandedContainer}>
                    ...
                    {this.state.refrences1Upload === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.nach.pdf ? 'space-around' : 'center', alignItems: this.state.eSign.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>
    ...
    renderDownPaymentReceipt() {
        ...
        if (this.state.preDisbursalDocument.downPaymentReceipt) {
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
                        this.handleCollapseExpand("downPaymentReceipt", false);
                    }}>
                        <Text style={pddLabel}>{PRE_DISBURSAL_DOCUMENT_CONST.DOWN_PAYMENT}</Text>
                        <Image source={BLUE_PLUS_ICON} style={plusImageStyle} />
                    </TouchableOpacity>
                </View>
            );
            ...
            return (
                <View style={expandedContainer}>
                    ...
                    {this.state.downPaymentUpload === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.downPaymentReceipt.pdf ? 'space-around' : 'center', alignItems: this.state.downPaymentReceipt.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>
                                {!this.state.downPaymentReceipt.pdf ?
                                    <Image
                                        source={{
                                            uri: `${this.state.downPaymentReceipt.filePath}`,
                                            // priority: Image.priority.high
                                        }}
                                        style={imagePlaceHolderStyle}
                                        onError={() =>
                            ...
                            {!this.state.downPaymentReceipt.pdf ?
                                <Text style={{ marginBottom: 10, alignSelf: 'center' }}>
                                    {/* <Text style={[textFileName, { color: colors.COLOR_BLACK, fontFamily: APP_FONTS.NunitoExtraBold }]}>File Name:</Text> */}
                                    <Text style={textFileName}> {this.state.downPaymentReceipt.filename}</Text>
                                </Text> : null}
                        </View>
                    )
                    }
    ...
    delarQuotation() {
        ...
        if (this.state.preDisbursalDocument.delarQuotation) {
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
            ...
            return (
                <View style={expandedContainer}>
                                                    ...
                                                    if (bytesToMegaBytes(image.size) > 5) {
                                                        ImageResizer.createResizedImage(image.path, 1200, 1200, 'JPEG', 100, 0)
                                                            .then((response) => {
                                                                this.setState((state, props) => ({
                                                                    delarQuotationDoc: {
                                                                        ...state.delarQuotationDoc,
                                                                        disbursementType: this.state.disbursementType,
                                                                        docType: "delarQuotation",
                                                                        applicantUniqueId: this.state.applicantUniqueId,
                                                                        filename: response.name,
                                                                        otherName: "",
                                                                    },
                                                                }));
                                                                zipFileDisbursementTakePhoto2(response, this.state.delarQuotationDoc, this.props.uploadDisbusementDOCUMENT, callback)
                                                            }).catch(err => {
                                                            });
                                                    } else {
                                                        this.setState((state, props) => ({
                                                        ...
                                                        zipFileDisbursementTakePhoto(image, this.state.delarQuotationDoc, this.props.uploadDisbusementDOCUMENT, callback)
                                                    }
                                                })
                                                const callback = (response) => {
                                                    this.setState({
                                                        delarQuotation: true,
                                                        delarQuotationDoc: {
                                                            filename: response.delarQuotation.fileName,
                                                            filePath: response.delarQuotation.filePath.replace('/var/www/html', uatURL.URL),
                                                            pdf: response.delarQuotation.fileName.split('.').pop() == 'pdf' ? true : false
                                                        }
                                    ...
                                    <Button
                                        ...
                                        onPress={async () => {
                                            if (!this.state.isViewOnly) {
                                                ...
                                                zipFileDisbursementUpload(fileDetails, this.state.delarQuotationDoc, this.props.uploadDisbusementDOCUMENT, callback);
                                            }
                                        }}
                                    />
                                </View>
                    ...
                    {this.state.delarQuotation === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.delarQuotationDoc.pdf ? 'space-around' : 'center', alignItems: this.state.delarQuotationDoc.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>

                                {!this.state.delarQuotationDoc.pdf ?
                                    <FastImage
                                        source={{
                                            uri: `${this.state.delarQuotationDoc.filePath}`,
                                            // priority: Image.priority.high
                                        }}
                                        style={imagePlaceHolderStyle}
                                        onError={() =>
                                    ...
                                    <View style={{
                                        ...
                                        <Image source={UPLOADIMAGEPDF} style={plusImageStyle1} />
                                        <TouchableOpacity onPress={() => {
                                            Linking.openURL(this.state.delarQuotationDoc.filePath)
                                        }
                                        }>
                                            <Text style={[textFileName, { flex: 1 }]}>
                                                {this.state.delarQuotationDoc.filename}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
                                }
                                        ...
                                        if (!this.state.isViewOnly) {
                                            this.props.deleteDisbursementDOCUMENT({
                                                data: {
                                                    ...
                                                    docType: "delarQuotation",
                                                    disbursementType: this.state.disbursementType,
                                                    docName: this.state.delarQuotationDoc.filename
                                                },
                                                callback: (response) => {
                                                    this.setState((state, props) => ({
                                                        delarQuotationDoc: {
                            ...
                            {!this.state.delarQuotationDoc.pdf ?
                                <Text style={{ marginBottom: 10, alignSelf: 'center', }}>
                                    {/* <Text style={[textFileName, { color: colors.COLOR_BLACK, fontFamily: APP_FONTS.NunitoExtraBold }]}>File Name:</Text> */}
                                    <Text style={textFileName}> {this.state.delarQuotationDoc.filename}</Text>
                                </Text>
                                : null}
    ...
    eSign() {
        ...
        if (this.state.preDisbursalDocument.eSign) {
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
                        this.handleCollapseExpand("eSign", false);
                    }}>
                        <Text style={pddLabel}>{"eSign*"}</Text>
                        <Image source={BLUE_PLUS_ICON} style={plusImageStyle} />
                    </TouchableOpacity>
                </View>
            );
            ...
            return (
                <View style={expandedContainer}>
                    ...
                    <View style={expandedViewStyle}>
                        <Text style={pddLabel}>{"eSign*"}</Text>
                        <TouchableOpacity onPress={() => {
                            this.handleCollapseExpand("eSign", true);
                        }}>
                            <Image source={MINUS_ICON} style={plusImageStyle} resizeMode="contain" />
                        </TouchableOpacity>
                    </View>
                                                    ...
                                                    if (bytesToMegaBytes(image.size) > 5) {
                                                        ImageResizer.createResizedImage(image.path, 1200, 1200, 'JPEG', 100, 0)
                                                            .then((response) => {
                                                                ...
                                                                zipFileDisbursementTakePhoto2(response, this.state.eSign, this.props.uploadDisbusementDOCUMENT, callback)
                                                            }).catch(err => {
                                                            });
                                                    } else {
                                                        this.setState((state, props) => ({
                                                        ...
                                                        zipFileDisbursementTakePhoto(image, this.state.eSign, this.props.uploadDisbusementDOCUMENT, callback)
                                                    }
                                                })
                                                const callback = (response) => {
                                                    this.setState({
                                                        eSignUpload: true,
                                                        eSign: {
                                                            filename: response.eSign.fileName,
                                                            filePath: response.eSign.filePath.replace('/var/www/html', uatURL.URL),
                                                            pdf: response.eSign.fileName.split('.').pop() == 'pdf' ? true : false
                                                        }
                                    ...
                                    <Button
                                        ...
                                        onPress={async () => {
                                            if (!this.state.isViewOnly) {
                                                ...
                                                zipFileDisbursementUpload(fileDetails, this.state.eSign, this.props.uploadDisbusementDOCUMENT, callback);
                                            }
                                        }}
                                    />
                                </View>
                    ...
                    {this.state.eSignUpload === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.eSign.pdf ? 'space-around' : 'center', alignItems: this.state.eSign.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>

                                {!this.state.eSign.pdf ?
                                    <FastImage
                                        source={{
                                            uri: `${this.state.eSign.filePath}`,
                                            // priority: Image.priority.high
                                        }}
                                        style={imagePlaceHolderStyle}
                                        onError={() =>
                                    ...
                                    <View style={{
                                        ...
                                        <Image source={UPLOADIMAGEPDF} style={plusImageStyle1} />
                                        <TouchableOpacity onPress={() => {
                                            Linking.openURL(this.state.eSign.filePath)
                                        }
                                        }>
                                            <Text style={[textFileName, { flex: 1 }]}>
                                                {this.state.eSign.filename}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
                                }
                                        ...
                                        if (!this.state.isViewOnly) {
                                            this.props.deleteDisbursementDOCUMENT({
                                                data: {
                                                    ...
                                                    docType: "eSign",
                                                    disbursementType: this.state.disbursementType,
                                                    docName: this.state.eSign.filename
                                                },
                                                callback: (response) => {
                                                    this.setState((state, props) => ({
                                                        eSign: {
                            ...
                            {!this.state.eSign.pdf ?
                                <Text style={{ marginBottom: 10, alignSelf: 'center', }}>
                                    {/* <Text style={[textFileName, { color: colors.COLOR_BLACK, fontFamily: APP_FONTS.NunitoExtraBold }]}>File Name:</Text> */}
                                    <Text style={textFileName}> {this.state.eSign.filename}</Text>
                                </Text>
                                : null}
    ...
    nach() {
        ...
        if (this.state.preDisbursalDocument.nach) {
            return (
                <View style={collapsedContainer}>
                    <TouchableOpacity style={collapsedViewStyle} onPress={() => {
                        this.handleCollapseExpand("nach", false);
                    }}>
                        <Text style={pddLabel}>{"eNACH*"}</Text>
                        <Image source={BLUE_PLUS_ICON} style={plusImageStyle} />
                    </TouchableOpacity>
                </View>
            );
            ...
            return (
                <View style={expandedContainer}>
                    ...
                    <View style={expandedViewStyle}>
                        <Text style={pddLabel}>{"eNACH*"}</Text>
                        <TouchableOpacity onPress={() => {
                            this.handleCollapseExpand("nach", true);
                        }}>
                            <Image source={MINUS_ICON} style={plusImageStyle} resizeMode="contain" />
                        </TouchableOpacity>
                    </View>
                                                    ...
                                                    if (bytesToMegaBytes(image.size) > 5) {
                                                        ImageResizer.createResizedImage(image.path, 1200, 1200, 'JPEG', 100, 0)
                                                            .then((response) => {
                                                                ...
                                                                zipFileDisbursementTakePhoto2(response, this.state.nach, this.props.uploadDisbusementDOCUMENT, callback)
                                                            }).catch(err => {
                                                            });
                                                    } else {
                                                        this.setState((state, props) => ({
                                                        ...
                                                        zipFileDisbursementTakePhoto(image, this.state.nach, this.props.uploadDisbusementDOCUMENT, callback)
                                                    }
                                                })
                                                const callback = (response) => {
                                                    this.setState({
                                                        nachUpload: true,
                                                        nach: {
                                                            filename: response.nach.fileName,
                                                            filePath: response.nach.filePath.replace('/var/www/html', uatURL.URL),
                                                            pdf: response.nach.fileName.split('.').pop() == 'pdf' ? true : false
                                                        }
                                    ...
                                    <Button
                                        ...
                                        onPress={async () => {
                                            if (!this.state.isViewOnly) {
                                                ...
                                                zipFileDisbursementUpload(fileDetails, this.state.nach, this.props.uploadDisbusementDOCUMENT, callback);
                                            }
                                        }}
                                    />
                                </View>
                    ...
                    {this.state.nachUpload === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.nach.pdf ? 'space-around' : 'center', alignItems: this.state.eSign.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>
                                ...
                                {!this.state.nach.pdf ?
                                    ...
                                    <View style={{
                                        ...
                                        <Image source={UPLOADIMAGEPDF} style={plusImageStyle1} />
                                        <TouchableOpacity onPress={() => {
                                            Linking.openURL(this.state.nach.filePath)
                                        }
                                        }>
                                            <Text style={[textFileName, { flex: 1 }]}>
                                                {this.state.nach.filename}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
                                }
                                        ...
                                        if (!this.state.isViewOnly) {
                                            this.props.deleteDisbursementDOCUMENT({
                                                data: {
                                                    ...
                                                    docType: "nach",
                                                    disbursementType: this.state.disbursementType,
                                                    docName: this.state.nach.filename
                                                },
                                                callback: (response) => {
                                                    this.setState((state, props) => ({
                                                        nach: {
                            ...
                            {!this.state.nach.pdf ?
                                <Text style={{ marginBottom: 10, alignSelf: 'center', }}>
                                    {/* <Text style={[textFileName, { color: colors.COLOR_BLACK, fontFamily: APP_FONTS.NunitoExtraBold }]}>File Name:</Text> */}
                                    <Text style={textFileName}> {this.state.nach.filename}</Text>
                                </Text>
                                : null}
            ...
            return (
                <View style={expandedContainer}>
                    ...
                    {this.state.eAgreementUpload === true && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: this.state.eAgreement.pdf ? 'space-around' : 'center', alignItems: this.state.eSign.pdf ? 'center' : 'flex-start', marginBottom: 10 }}>
            ...
            <View style={buttonNavigation}>
                ...
                <View style={{ flex: 1 }}>
                    <Button
                        ...
                        onPress={() => {
                            this.state.nach.filename !== null && this.state.custDoc.filename !== null  && this.state.delarQuotation.filename !== null && this.state.eSign.filename !== null ?
