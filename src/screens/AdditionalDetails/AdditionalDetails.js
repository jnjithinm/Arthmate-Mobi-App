...
import {
  selectPDF1,
  zipFileDisbursementUpload,
  uploadDocument,
} from '../../../uploadImageUtils';
import {
  MOBILE_NUMBER_REGEX,
  NUMBER_REGEX,
  CONSUMER_NO_REGEX,
...
class AdditionalDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      utilityDocList: [
        ...
        {
          id: 2,
          label: 'Aadhar + Driving Licence',
          value: 'Aadhar + Driving Licence',
        },
  ...
  apiCall = () => {
    this.focusListener = this.props.navigation.addListener('didFocus', () => {
      ...
      this.props.getStateList({
        callback: (response) => {
          const stateDropdown = response.data.map((value) => ({
            value,
            label: value,
          }));
          this.setState({stateList: stateDropdown});
        },
      });
      ...
      setTimeout(() => {
        ...
        this.props.getQDEData({
          ...
          callback: (response) => {
            this.setState({
              pangstDocType: this?.props?.userQDEDataSelector?.pangstdetails
                ?.documentType,
              selectedSourceType:
                response?.pangstdetails?.entity == 'Sole Proprietory Firm'
                  ? 'Proprietor'
                  : 'Partner',
            });
            this.setState({
              ...
              permanentVisible:
                response?.actualPermanentAddDetailsFlag || false,
            });
            ...
            if (
              ...
              const additionalDetailsData = this.props.userQDEDataSelector
                .additionalDetails;
              const pangstdetails = this.props.userQDEDataSelector
                .pangstdetails;
              ...
              this.setState({
                cancelButtonTitle:
                  additionalDetailsData.kycaddresDetails.address1 !== undefined
                    ? 'Loan Summary'
                    : 'Cancel',
                leadCode:
                  ...
                  this.setState(
                    {
                      isViewOnly: response?.mainapplicant?.loanSchemeFreeze
                        ...
                        ? true
                        : response?.mainapplicant?.bureauStatus
                        ? true
                        : // response?.mainapplicant?.loanAgreementFlag ? true :
                        response?.modelAccess[0]?.read
                        ? true
                        : false,
                      kycFreeze: response?.mainapplicant?.kycFreeze
                        ? true
                        : response?.mainapplicant?.dedupeStatus
                        ? true
                        : response?.mainapplicant?.bureauStatus
                      ...
                      if (additionalDetailsData.kycaddresDetails) {
                        ...
                        if (additionalDetailsData?.kycaddresDetails?.filePath) {
                          (
                            ...
                            if (
                              docType.toLowerCase().includes('front') ||
                              docType.toLowerCase().includes('other')
                            ) {
                              imageData.front.uri = this.state.kycFreeze
                                ? filePath.replace('/var/www/html', uatURL.URL)
                                : pangstdetails?.documentType == 'form60' &&
                                  additionalDetailsData.kycaddresDetails
                        ...
                        this.setState({
                          ...
                          idToEditKYCData:
                            additionalDetailsData.kycaddresDetails.id || null,
                          selectedResidentType: {
                            value: this.state.kycFreeze
                          ...
                          selectedDocType: this.state.kycFreeze
                            ? additionalDetailsData?.kycaddresDetails
                              ...
                              ? 'adhar'
                              : additionalDetailsData?.kycaddresDetails
                                  ?.identityProofType === 'drivingLicense'
                              ? 'driving license'
                              : additionalDetailsData?.kycaddresDetails
                                  ?.identityProofType
                            : pangstdetails?.documentType == 'form60'
                          ...
                          addharName:
                            additionalDetailsData.kycaddresDetails.addharName ||
                            '',
                          adharID:
                            additionalDetailsData?.kycaddresDetails
                              ?.identityProofType === 'aadhar' ||
                            additionalDetailsData?.kycaddresDetails
                              ?.identityProofType === 'adhar'
                              ? additionalDetailsData?.kycaddresDetails?.identityProofNo?.replace(
                                  /\d{4}(?=.)/g,
                                  '$& ',
                                )
                              : '',
                ...
                this.setState(
                  {
                    isFirstJob: {
                      value:
                        additionalDetailsData.employedetails.firstJob == true
                          ? true
                          : additionalDetailsData.employedetails.firstJob ==
                            false
                          ? false
                          : null,
                      // isValid: true,
                    ...
                    jobMonth: {
                      value:
                        additionalDetailsData.employedetails.jobMonth ==
                        undefined
                          ? null
                          : additionalDetailsData.employedetails.jobMonth,
                      label:
                        additionalDetailsData.employedetails.jobMonth !==
                        undefined
                          ? additionalDetailsData.employedetails.jobMonth.toString()
                          : null,
                    },
                    employmentData:
                      additionalDetailsData.employedetails.jobYear !== undefined
                        ? true
                        : false,
                    jobYear:
                      additionalDetailsData.employedetails.jobYear == undefined
                        ? ''
                        : additionalDetailsData.employedetails.jobYear,
                    empMonth: {
                      value:
                        additionalDetailsData.employedetails.empMonth ==
                        undefined
                          ? null
                          : additionalDetailsData.employedetails.empMonth,
                      label:
                    ...
                    empYear:
                      additionalDetailsData.employedetails.empYear == undefined
                        ? ''
                        : additionalDetailsData.employedetails.empYear,
                    employmentCity:
                      additionalDetailsData.employedetails.city || '',
                    employmentState:
                      additionalDetailsData.employedetails.state || '',
                    empEmail: {
                      value:
                        additionalDetailsData.employedetails.empOfficeEmail,
                      isValid: true,
                    },
                    selectedProfession: {
                      value:
                        additionalDetailsData.employedetails.empProfession ||
                        null,
                      label:
                        additionalDetailsData.employedetails.empProfession ||
                        null,
                    ...
                    selectedDesignation: {
                      value:
                        additionalDetailsData.employedetails.designation ||
                        null,
                      label:
                        additionalDetailsData.employedetails.designation ||
                        null,
                    ...
                    selectedsubCategory: {
                      value:
                        additionalDetailsData.employedetails.empSubCategory ||
                        null,
                      label:
                        additionalDetailsData.employedetails.empSubCategory ||
                        null,
                    ...
                    selectedCompanyType: {
                      value:
                        additionalDetailsData.employedetails.empConstitution ||
                        null,
                      label:
                        additionalDetailsData.employedetails.empConstitution ||
                        null,
                    ...
                    selectedIndustry: {
                      value:
                        additionalDetailsData.employedetails.empIndustry ||
                        null,
                      label:
                        additionalDetailsData.employedetails.empIndustry ||
                        null,
                    ...
                    selectedCompanyName:
                      additionalDetailsData.employedetails.company || '',
                    query: additionalDetailsData.employedetails.company || '',
                    companyName:
                      additionalDetailsData.employedetails
                        .empOtherCompanyName || '',
                    idToEditEmployDetails:
                      additionalDetailsData.employedetails.id || null,
                  },
                  () => {
              ...
              if (additionalDetailsData.alternateContact) {
                this.setState({
                  mobileNumber: {
                    value:
                      additionalDetailsData.alternateContact.mobileNo || '',
                    isValid: true,
                  },
                  contactData:
                    additionalDetailsData.alternateContact.mobileNo !==
              ...
              if (additionalDetailsData.officeAddresDetails) {
                this.setState({
                  ...
                  empAddress1: {
                    value:
                      additionalDetailsData.officeAddresDetails.address1 || '',
                  },
                  empAddress2: {
                    value:
                      additionalDetailsData.officeAddresDetails.address2 || '',
                  },
                  empLandmark1: {
                    value:
                      additionalDetailsData.officeAddresDetails.landmark1 || '',
                  },
                  empLandmark2: {
                    value:
                      additionalDetailsData.officeAddresDetails.landmark2 || '',
                  },
                  empPincode: {
                    value:
                      additionalDetailsData.officeAddresDetails.pinCode || '',
                    isValid: true,
                  },
                  ...
                  empState:
                    additionalDetailsData.officeAddresDetails.state || '',
                  selectedEmpType: {
              ...
              if (
                additionalDetailsData?.currentOfficeAddresDetails &&
                ...
                this.setState({
                  ...
                  imageDataCurrent: {
                    ...
                    back: {
                      uri:
                        additionalDetailsData?.currentOfficeAddresDetails?.currentAddressFilePathBack?.replace(
                          '/var/www/html',
                          uatURL.URL,
                        ) || '',
                      data: '',
                  ...
                  officeAddress1: {
                    value: additionalDetailsData.currentOfficeAddresDetails
                  ...
                  officeData:
                    ...
                    undefined
                      ? true
                      : false,
                  officeCity: additionalDetailsData.currentOfficeAddresDetails
                    .sameRegisteredAddressFlag
                    ? additionalDetailsData.kycaddresDetails.city || ''
                    : additionalDetailsData.currentOfficeAddresDetails.city ||
                      '',
                  officeState: additionalDetailsData.currentOfficeAddresDetails
                    .sameRegisteredAddressFlag
                    ? additionalDetailsData.kycaddresDetails.state || ''
                  ...
                  officeYear: additionalDetailsData.currentOfficeAddresDetails
                    .sameRegisteredAddressFlag
                    ? additionalDetailsData.kycaddresDetails.kycYear || ''
                    : additionalDetailsData.currentOfficeAddresDetails
                        .officeYear || '',
                  ...
                  isSelected1:
                    additionalDetailsData.currentOfficeAddresDetails
                      .sameRegisteredAddressFlag || false,
                  gstAddressFlag:
                    additionalDetailsData.currentOfficeAddresDetails
                      .gstAddressFlag,
                });
              ...
              if (
                additionalDetailsData.officeAddresDetails &&
                pangstdetails?.occupationType == 'salaried'
              ) {
                this.setState({
                  idToEditOfficeAddress:
                  ...
                  officeData:
                    additionalDetailsData.officeAddresDetails.city !== undefined
                      ? true
                      : false,
                  officeCity:
                    additionalDetailsData.officeAddresDetails.city || '',
                  officeState:
                    additionalDetailsData.officeAddresDetails.state || '',
                });
              }
              if (
                actualPermanentAddDetails != '' &&
                actualPermanentAddDetails != null
              ) {
                this.setState({
                  ...
                  imageDataPermanent: {
                    front: {
                      uri:
                        actualPermanentAddDetails?.filePath?.replace(
                          '/var/www/html',
                          uatURL.URL,
                        ) || '',
                    },
                    back: {
                      uri:
                        actualPermanentAddDetails?.filePathBack?.replace(
                          '/var/www/html',
                          uatURL.URL,
                        ) || '',
                    },
                  },
                  permanantResiAddressData:
                    actualPermanentAddDetails.permanentCity !== undefined
                      ? true
                      : false,
                  permanentResAddr1: {
                  ...
                  permanentResLandmark1: {
                    value:
                      actualPermanentAddDetails.permanentAddressLandmark1 || '',
                  },
                  permanentResLandmark2: {
                    value:
                      actualPermanentAddDetails.permanentAddressLandmark2 || '',
                  },
                  permanentResPincode: {
                  ...
                  permanentResCity:
                    actualPermanentAddDetails.permanentCity || '',
                  permanentResState:
                    actualPermanentAddDetails.permanentState || '',
                  sameAsKycAddress: actualPermanentAddDetails.sameAsKycAddress,
                  permanentResYear:
                    actualPermanentAddDetails.permanentYear || '',
                  permanentResMonth: {
                    value:
                      Number(actualPermanentAddDetails?.permanentMonth) || null,
              ...
              if (
                additionalDetailsData.permanentaddresDetails &&
                ...
                this.setState({
                  ...
                  permanentAddress1: {
                    value: additionalDetailsData.permanentaddresDetails
                      .sameKycFlag
                      ? additionalDetailsData.kycaddresDetails.address1
                  ...
                  permanentLandmark1: {
                    value:
                      additionalDetailsData.permanentaddresDetails.landmark1 ||
                      '',
                  },
                  permanentLandmark2: {
                    value:
                      additionalDetailsData.permanentaddresDetails.landmark2 ||
                      '',
                  },
                  permanentPincode: {
                    value: additionalDetailsData.permanentaddresDetails
                  ...
                  permanantAddressData:
                    ...
                    undefined
                      ? true
                      : false,
                  permanentCity: additionalDetailsData.permanentaddresDetails
                    .sameKycFlag
                    ? additionalDetailsData.kycaddresDetails.city || ''
                    : additionalDetailsData.permanentaddresDetails.city || '',
                  permanentState: additionalDetailsData.permanentaddresDetails
                    .sameKycFlag
                    ? additionalDetailsData.kycaddresDetails.state || ''
                    : additionalDetailsData.permanentaddresDetails.state || '',
                  isSelected:
                    additionalDetailsData.permanentaddresDetails.sameKycFlag,
                  permanentYear: additionalDetailsData.permanentaddresDetails
                    .sameKycFlag
                    ? additionalDetailsData.kycaddresDetails.kycYear || ''
              ...
              if (additionalDetailsData.utilityDetails) {
                ...
                (imageDataUtility.front.uri =
                  additionalDetailsData?.utilityDetails?.filePath?.replace(
                    '/var/www/html',
                    uatURL.URL,
                  ) || ''),
                  (imageDataUtility.back.uri =
                    additionalDetailsData?.utilityDetails?.filePathBack?.replace(
                      '/var/www/html',
                      uatURL.URL,
                    ) || '');
                // }
                this.setState(
                  {
                    ...
                    selectedUtilityDoc: {
                      value:
                        additionalDetailsData.utilityDetails
                          .otherResidanceType || null,
                      label:
                        additionalDetailsData.utilityDetails
                          .otherResidanceType || null,
                    },
                    utilityAddressType: {
                      value:
                        additionalDetailsData.utilityDetails.addressType ==
                        'currentAddress'
                          ? true
                          : additionalDetailsData.utilityDetails.addressType ==
                            'permanentAddress'
                    ...
                    utilityAddressLine1: {
                      value:
                        additionalDetailsData.utilityDetails.address1 || '',
                    },
                    utilityAddressLine2: {
                      value:
                        additionalDetailsData.utilityDetails.address2 || '',
                    },
                    utilityLandmark1: {
                      value:
                        additionalDetailsData.utilityDetails.landmark1 || '',
                    },
                    utilityLandmark2: {
                      value:
                        additionalDetailsData.utilityDetails.landmark2 || '',
                    },
                    utilityPincode: {
                    ...
                    utilityEpicNo:
                      additionalDetailsData.utilityDetails.epicNo || '',
                    utilityDlNo:
                      additionalDetailsData.utilityDetails.drivingLicenceNo ||
                      '',
                    utilityDateOfBirthText:
                      additionalDetailsData.utilityDetails.dateOfBirth || '',
                    lpgID: additionalDetailsData.utilityDetails.lpgId || '',
                    utilityServiceProvider: {
                      value:
                        additionalDetailsData.utilityDetails.serviceProvider ||
                        '',
                      label: null,
                    },
                    utilityFileNumber:
                      additionalDetailsData.utilityDetails.fileNumber || '',
                    utilityTelephoneNo:
                      additionalDetailsData.utilityDetails.telephoneNo || '',
                    utilityCity:
                      additionalDetailsData.utilityDetails.telephoneCity || '',
                    utilityBillData:
                      additionalDetailsData.utilityDetails.city !== undefined
                        ? true
                        : false,
                    utilityCity:
                      additionalDetailsData.utilityDetails.city || '',
                    utilityState:
                      additionalDetailsData.utilityDetails.state || '',
                    // lpgID: additionalDetailsData.utilityDetails.billNumer || '',
                    cityNameUtility:
                      additionalDetailsData.utilityDetails.landLineCity || '',
                    landlineNumber:
                      additionalDetailsData.utilityDetails.landLineNumber || '',
                    stdCode: additionalDetailsData.utilityDetails.std || '',
                    utilitySelectedResidentType: {
                      value:
                        additionalDetailsData.utilityDetails.residenceType ||
                        null,
                      label:
                        additionalDetailsData.utilityDetails.residenceType ||
                        null,
                    ...
                    additionalDetailOptions: {
                      additionalContactCollapsed:
                        additionalDetailsData.alternateContact.mobileNo !==
                        undefined
                          ? false
                          : true,
                      employementDetailsCollapsed:
                        additionalDetailsData.employedetails.jobYear !==
                        undefined
                          ? false
                          : true,
                      officeAddressCollapsed:
                        additionalDetailsData.currentOfficeAddresDetails
                          .city !== undefined
                          ? false
                          : true,
                      permanentAddressCollapsed:
                        additionalDetailsData.permanentaddresDetails.city !==
                        undefined
                          ? false
                          : true,
                  ...
                  () => {
                    if (this.state.selectedUtilityBill === 'electricity') {
                      ...
                      this.state.serviceProviderList.forEach((item) => {
                        if (
                          item.code ==
                          additionalDetailsData.utilityDetails.serviceProvider
                        ) {
                      ...
                      this.setState({
                        ...
                        consumerNumber:
                          additionalDetailsData.utilityDetails.billNumer || '',
                      });
                    }
                  },
                );
                    ...
                    const callback = (response) => {
                      this.setState({
                        imageDataCurrent: {
                          ...
                          front: {
                            uri: response.currentAddressFilePath.replace(
                              '/var/www/html',
                              uatURL.URL,
                            ),
                          },
                  ...
                  const callback = (response) => {
                    this.setState({
                      imageDataCurrent: {
                        ...this.state.imageDataCurrent,
                        back: {
                          uri: response.currentAddressFilePathBack.replace(
                            '/var/www/html',
                            uatURL.URL,
                          ),
                        },
      ...
      <View style={residentialAddressContainer}>
        ...
        {!this.state.permanentPincode.isValid && (
          ...
          <View style={{width: '100%', marginTop: 15}}>
            ...
            {!this.state.permanentCityVerified && (
              <Text style={{color: 'red', marginTop: 3}}>
                {ADDITIONAL_DETAILS_CONST.INVALID_CITY_NAME}
              </Text>
            )}
          </View>
          ...
          <View style={{width: '100%', marginTop: 15}}>
            <DropDownPicker
              ...
              defaultValue={this.state.permanentState}
              placeholder={''}
        ...
        <>
          <Text
            style={[
              kycDocLabel,
              {marginTop: 20, fontFamily: APP_FONTS.NunitoBold},
            ]}>
              ...
              <FloatingLabelInput
                ...
                value={
                  this.state.permanentYear == ''
                    ? this.state.permanentYear
                    : this.state.permanentYear.toString()
                }
                keyboardType="number-pad"
                onChangeText={(value) => {
                    ...
                    callback: (response) => {
                      const dataForgetQDE = {
                        ...
                        ismainapplicant: this.props.navigation.state.params
                          .ismainapplicant,
                        isguarantor: this.props.navigation.state.params
                          .isguarantor,
                      };
                      this.props.getQDEData({
                        dataForgetQDE,
                        callback: (response) => {
                          this.setState(
                            {
                              indSelfSoleFlag:
                                response?.indSelfSoleFlag || false,
                              permanentVisible:
                                response?.actualPermanentAddDetailsFlag ||
                                false,
                            },
                            () => {
                ...
                () => {
                  this.setState({
                    ...
                    permanentResPincode: {
                      ...
                      isValid: !this.state.sameAsKycAddress
                        ? true
                    ...
                    permanentResCity: !this.state.sameAsKycAddress
                      ? ''
                      : this.state.city,
                    permanentResState: !this.state.sameAsKycAddress
                      ? ''
                      : this.state.state,
        ...
        {!this.state.permanentResPincode.isValid && (
          ...
          <View style={{width: '100%', marginTop: 15}}>
            <DropDownPicker
              ...
              defaultValue={this.state.permanentResState}
              // placeholder={'ddd'}

              dropDownStyle={{backgroundColor: '#ffffff'}}
              onChangeItem={(item) => {
                this.setState({
                  permanentResState: item.value,
                  permanentResStateVerified:true
                });
              }}
              customArrowUp={() => <Image source={UP_ARROW} />}
              customArrowDown={() => <Image source={DOWN_ARROW} />}
              labelStyle={textStyle}
              selectedLabelStyle={[textStyle, {color: colors.COLOR_BLACK,fontSize:9}]}
            />
            <Text
              style={[
                textStyle,
        ...
        {!this.state.officePincode.isValid && (
          ...
          <View style={{width: '100%', marginTop: 15}}>
            <DropDownPicker
              ...
              defaultValue={this.state.officeState}
              // placeholder={'ddd'}

              dropDownStyle={{backgroundColor: '#ffffff'}}
              onChangeItem={(item) => {
                this.setState({
                  officeState: item.value,
                  officeStateVerified: true,
                });
              }}
              customArrowUp={() => <Image source={UP_ARROW} />}
            ...
            <View style={{marginBottom: 10, marginTop: 15}}>
              ...
              <DropDownPicker
                ...
                onChangeItem={(item) => {
                  this.setState({
                    residenceFlag:
                      item.value == 'PG' || item.value == 'Corporate Provided'
                        ? false
                        : true,
                    isSelected: false,
                    selectedOfficeType: {
                  ...
                  <FloatingLabelInput
                    ...
                    value={
                      this.state.officeYear == ''
                        ? this.state.officeYear
                        : this.state.officeYear.toString()
                    }
                    keyboardType="number-pad"
                    onChangeText={(value) => {
                      // this?.state?.year.length < 2 ?
      ...
      <View style={residentialAddressContainer}>
        ...
        {!this.state.empPincode.isValid && (
          ...
          <View style={{width: '100%', marginTop: 15}}>
            <DropDownPicker
              ...
              defaultValue={this.state.empState || undefined}
              // placeholder={'ddd'}
        ...
        <Button
          isDisabled={
            ...
            this.state.isFirstJob.value === false
              ? this.state.empYear === '' ||
                this.state.empMonth.value === null ||
                !this.validateExp()
          ...
          onPress={() => {
            const dataToAPI = {
              ...
              empMonth:
                this.state.isFirstJob.value == false
                  ? this.state.empMonth.value
                  : null,
              empYear:
                this.state.isFirstJob.value == false ? this.state.empYear : '',
            };
            //mj
            const dataToAPI1 = {
              msgHide: true,
  ...
  getDocId() {
    ...
    if (
      ...
      (this.state.fileNumber === '' ||
        ...
        moment(this.state.dateOfBirthText, [
          'MM-DD-YYYY',
          'DD-MM-YYYY',
          'YYYY-MM-DD',
          'DD/MM/YYYY',
    ...
    if (
      ...
      (this.state.dlNo === '' ||
        ...
        moment(this.state.dateOfBirthDLText, [
          'MM-DD-YYYY',
          'DD-MM-YYYY',
          'YYYY-MM-DD',
          'DD/MM/YYYY',
    ...
    if (
      (this?.state?.selectedDocType === 'voter' && this.state.epicNo === '') ||
      ...
      if (
        ...
        (this.state.kycData == false ||
          ...
          (this.state.permanentVisible == true &&
            this.state.permanantResiAddressData == false))
      ) {
        return true;
      }
      if (
        this.state.residenceFlag &&
        (this.state.kycData == false ||
          // this.state.utilityBillData == false ||
          this.state.permanantAddressData == false ||
          this.state.employmentData == false ||
        ...
        {(flow === 'fromUtility'
          ...
          <View style={{width: '100%', marginTop: 15}}>
            ...
            {flow === 'fromUtility' && !this.state.utilityStateVerified && (
              <Text style={{color: 'red', marginTop: 3}}>
                {ADDITIONAL_DETAILS_CONST.INVALID_STATE_NAME}
              </Text>
            )}
          ...
          {flow === 'fromUtility' && (
            <View style={{marginBottom: 15, marginTop: 0}}>
              ...
              <DropDownPicker
                ...
                items={
                  this.state.indSelfSoleFlag
                    ? this.state.dropDownResidentType1
                    : this.state.dropdownKyc
                }
                containerStyle={{flex: 1, marginTop: 5, marginBottom: 15}}
                style={{backgroundColor: '#ffffff', borderWidth: 0}}
                itemStyle={{
          ...
          <Button
            ...
            onPress={() => {
              ...
              if (this?.state?.selectedDocType === 'adhar') {
                (dataToAPI[
                  'aadharId'
                ] = this?.state?.adharID?.toString()?.replace(/ /g, '')),
              ...
              if (this.state.imageData.front.uri == '') {
                ...
                Number(this.state.addressLine1.value.length) < 30 &&
                (Number(this.state.addressLine2.value.length) < 30 ||
                  Number(this.state.addressLine2.value.length) == 0)
                                        ...
                                        this.props.navigation.navigate(
                                          'Dedupe',
                                          {
                                            applicantUniqueId: this.state
                                              .applicantUniqueId,
                                            leadCode: this.state.leadCode,
                                            roleId: this.props.userDataSelector
                                              .userData.data.roleId,
                                            leadName: this.state.leadName,
                                            mobileNumber: this.state
                                              .mobileNumberFromProps,
                                            coapplicantUniqueId: this.state
                                              .coapplicantUniqueId,
                                            ismainapplicant: this.state
                                              .ismainapplicant,
                                            iscoapplicant: this.state
                                              .iscoapplicant,
                                            isguarantor: this.state.isguarantor,
                                          },
                                        );
            ...
            customContainerStyle={
              this.getSaveDisable() || this.state.isViewOnly
                ? disableStyle
                : saveButtonStyle
            }
            cutomTitleStyle={
            ...
            onPress={() => {
              ...
              if (this.state.selectedUtilityBill === 'electricity') {
                dataToAPI = {
                  ...
                  utilityBillAuthResponseStatus: this.state
                    .utilityBillAuthResponseStatus,
                };
              }
              if (this.state.selectedUtilityBill === 'gas') {
                dataToAPI = {
              ...
              if (
                this.state.selectedUtilityDoc.value ===
  ...
  validateExp() {
    ...
    if (
      this.state.empYear == this.state.jobYear &&
      this.state.empMonth.value != this.state.jobMonth.value &&
      this.state.empMonth.value >= this.state.jobMonth.value
    ) {
      return true;
    } else {
                ...
                <View style={{width: '90%', marginTop: 5}}>
                  <FloatingLabelInput
                    ...
                    value={
                      this.state.radioOther == ''
                        ? this.state.radioOther
                        : this.state.radioOther.toString()
                    }
                    onChangeText={(value) => {
            ...
            {!this.state.adharIdValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.adharID == ''
                  ...
                  : ADDITIONAL_DETAILS_CONST.INVALID_AADHAR_NUMBER}
              </Text>
            )}
          </View>
          <View style={marginTop20Style}>
            ...
            {!this.state.adharNameValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.addharName == ''
                  ...
                  : ADDITIONAL_DETAILS_CONST.INVALID_AADHAR_NAME}
              </Text>
            )}
          </View>
        </>
            ...
            {!this.state.fileNumberValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.fileNumber == ''
                  ...
                  : ADDITIONAL_DETAILS_CONST.INVALID_FILE_NUMBER}
              </Text>
            )}
          </View>
          <TouchableOpacity
            ...
            {moment(this.state.dateOfBirthText, [
              ...
              <Text style={{color: 'red', marginTop: 3}}>
                {ADDITIONAL_DETAILS_CONST.INVALID_DOB}
              </Text>
            )}
          </TouchableOpacity>
          <DatePickerDialog
            ...
            {!this.state.dlNoValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.dlNo == ''
                  ...
                  : ADDITIONAL_DETAILS_CONST.INVALID_DL_NUMBER}
              </Text>
            )}
          </View>
          ...
          {!this.state.epicNoValid && (
            <Text style={{color: 'red', marginTop: 3}}>
              {this.state.epicNo == ''
                ...
                : ADDITIONAL_DETAILS_CONST.INVALID_EPIC_NUMBER}
            </Text>
          )}
        </View>
      );
        ...
        <View>
          ...
          <View>
            ...
            {!this.state.consumerNumberValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.consumerNumber == ''
                  ? ADDITIONAL_DETAILS_CONST.REQUIRED_CONSUMER_NUMBER
                  : ADDITIONAL_DETAILS_CONST.INVALID_CONSUMER_NUMBER}
              </Text>
            )}
          </View>
        </View>
        ...
        <>
          <View style={marginTop20Style}>
            ...
            {!this.state.lpgValid && (
              <Text style={{color: 'red', marginTop: 3}}>
                {this.state.lpgID === ''
                  ? ADDITIONAL_DETAILS_CONST.REQUIRED_LPG_NUMBER
                  : ADDITIONAL_DETAILS_CONST.INVALID_LPG_NUMBER}
              </Text>
            )}
          </View>
        </>
          ...
          {this?.state?.selectedUtilityDoc.value === 'Passport' && (
            <View>
              ...
              <TouchableOpacity
                ...
                <View style={separatorInputStyle} />
                {moment(this.state.utilityDateOfBirth, [
                  'MM-DD-YYYY',
                  'YYYY-MM-DD',
                  'DD/MM/YYYY',
                ]) > moment().clone().subtract(18, 'years') && (
            ...
            <View>
              <View style={{}}>
                ...
                {!this.state.utilityTelephoneNoValid && (
                  <Text style={{color: 'red', marginTop: 3}}>
                    {this.state.utilityTelephoneNo == ''
                      ? ADDITIONAL_DETAILS_CONST.REQUIRED_TELEPHONE_NUMBER
                      : ADDITIONAL_DETAILS_CONST.INVALID_TELEPHONE_NUMBER}
                  </Text>
                )}
                ...
                {!this.state.utilityCityValid && (
                  <Text style={{color: 'red', marginTop: 3}}>
                    {this.state.utilityCity == ''
                      ? ADDITIONAL_DETAILS_CONST.REQUIRED_CITY_NAME
                      : ADDITIONAL_DETAILS_CONST.INVALID_CITY_NAME}
                  </Text>
                )}
              </View>
                ...
                imageData: JSON.stringify([
                  {
                    ...
                    isguarantor: this.state.isguarantor,
                    docName: this.state.imageDataUtility.front.data.path
                      .split('/')
                      .pop(),
                    applicantUniqueId:
                      this.state.isguarantor || this.state.iscoapplicant
            ...
            zip(sourcePath, targetPath)
              .then((path) => {
                const dataToAPI = {
                  imageData: JSON.stringify([
                    {
                      docName: this.state.imageData.front.data.path
                        .split('/')
                        .pop(),
  ...
  getOCRdata(response) {
    ...
    if (response && this?.state?.selectedDocType === 'driving license') {
      this.setState({
        ...
        dlNoValid:
          response && response.dlno && EPICNO_REGEX.test(response.dlno),
    ...
    if (response && this?.state?.selectedDocType === 'voter') {
      this.setState({
        ...
        epicNoValid:
          response && response.voterNo && EPICNO_REGEX.test(response.voterNo),
        addressLine1: {
          ...this.state.addressLine1,
    ...
    if (
      ...
      this.setState({
        ...
        fileNumberValid:
          response &&
          response.passportNum &&
          PASSPORT_REGEX.test(response.passportNum),
              ...
              .then((path) => {
                const dataToAPI = {
                  imageData: JSON.stringify([
                    ...
                    {
                      docName: this.state.imageData.back.data.path
                        .split('/')
                        .pop(),
                      docType: this.getDocType('back'),
                      // docType: 'back',
  ...
  displaybackUploadedImage(flow) {
    if (flow === 'fromUtility' && this.state.imageDataUtility.back.uri !== '') {
      return true;
                      ...
                      if (
                        ...
                        const dataToAPI = {
                          ...
                          dateOfBirth: this.state.dateOfBirthDLText.includes(
                            ...
                            ? this.FormatDateToDash(
                                this.state.dateOfBirthDLText,
                              )
                            : moment(this.state.dateOfBirthDL).format(
                                'DD-MM-YYYY',
                              ),
                          applicantUniqueId:
                            this.state.isguarantor || this.state.iscoapplicant
                          ...
                          callback: (response) => {
                            this.setState({
                              ...
                              addressLine1: {
                                ...this.state.addressLine1,
                                value:
                                  response?.data?.address[0]?.completeAddress ||
                                  '',
                              },
                              pincode: {
                                ...this.state.pincode,
          ...
          <>
            {this.state.selectedDocType == 'adhar' ? (
              ...
              <View>
                ...
                />
                <Text style={docTextStyle}>
                  {ADDITIONAL_DETAILS_CONST.PASSPORT}
                </Text>
              ...
              <View>
                ...
                />
                <Text style={docTextStyle}>
                  {ADDITIONAL_DETAILS_CONST.VOTER_ID}
                </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              this.handleCollapseExpand(
                'permanentResidenceAddrCollapsed',
                false,
              );
            }}>
            <Text style={registeredAddressLabel}>{'Permanent Address*'}</Text>
            <Image source={BLUE_PLUS_ICON} style={plusImageStyle} />
          </TouchableOpacity>
        </View>
      );
